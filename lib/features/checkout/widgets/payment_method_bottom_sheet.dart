...
class _PaymentMethodBottomSheetState extends State<PaymentMethodBottomSheet> {
  ...
  void initState() {
    ...
    print(
        '=====check: ${widget.storeId == null} && ${widget.isDigitalPaymentActive} && ${notHideDigital}');
  }
  ...
  Widget build(BuildContext context) {
    ...
    log("testing     //////////" +
        ...
        ' ' +
        widget.isWalletActive.toString());
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: GetBuilder<CheckoutController>(
                          ...
                          bool zonepaymentisSelected =
                              checkoutController.paymentMethodIndex == 2 &&
                                  locationController
                                          .zoneData![0].payment_gateway_title ==
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  if (widget.isCashOnDeliveryActive &&
                                      notHideCod)
                                    Padding(
                                      padding: EdgeInsets.only(
                                        bottom: widget.storeId == null &&
                                                widget.isWalletActive &&
                                                notHideWallet &&
                                                isLoggedIn
                                            ? Dimensions.paddingSizeSmall
                                  ...
                                  if (widget.storeId == null &&
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(
                                        top: widget.isCashOnDeliveryActive &&
                                                notHideCod
                                            ? 0
                                            : 0,
                                      ),
                              ...
                              locationController.zoneData != null &&
                                      locationController.zoneData!.isNotEmpty &&
                                      locationController
                                              .zoneData![0].digitalPayment !=
                                          null
                                  ? (locationController
                                          .zoneData![0].digitalPayment!
                                      ? PaymentButtonNew(
                                          isSelected: zonepaymentisSelected,
                                          icon: "${""}",
                                          title: locationController.zoneData![0]
