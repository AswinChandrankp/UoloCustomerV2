...
//                 topBarPadding: const EdgeInsets.symmetric(vertical: 10),
...
class IndiaCodeWidget extends StatelessWidget {
  final TextStyle? textStyle;
  final double flagWidth;
  final bool showFlag;
  final bool showText;
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if (showFlag && showText) const SizedBox(width: 8),
          if (showText)
            Text(
              '+91',
