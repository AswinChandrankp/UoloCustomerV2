...
class _ItemBottomSheetState extends State<ItemBottomSheet> {
  ...
  void initState() {
    ...
    isMultiSelect = widget.item!.foodVariations!
        .any((element) => element.multiSelect == true);
        ...
        for (int index = 0; index < widget.item!.addOns!.length; index++) {
          if (itemController.addOnActiveList[index]) {
            addonsCost = addonsCost +
                (widget.item!.addOns![index].price ?? 0) *
                                                        ...
                                                        : GetBuilder<
                                                            ...
                                                            return InkWell(
                                                              onTap: () {
                                                                if (AuthHelper
                                                                    .isLoggedIn()) {
                                                                  wishList.wishItemIdList.contains(
                                                                          widget
                                                                              .item!
                                                                              .id)
                                                              ...
                                                              child: Container(
                                                                ...
                                                                margin: const EdgeInsets
                                                                    ...
                                                                    top: Dimensions
                                                                        .paddingSizeSmall),
                                                                child: Icon(
                                                                  wishList.wishItemIdList.contains(widget
                                                                          .item!
                                                                          .id)
                                                                      ? Icons
                                                                          .favorite
                              ...
                              children: [
                                Text(
                                  item!.foodVariations![index].required!
                                      ...
                                      : 'optional'.tr,
                                  style: const TextStyle(
                                      fontSize: 13, color: Color(0xFF868686)),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  ...
                                                                  style: itemController.selectedVariations[variationIndex]
                                                                              [
                                                                              valueIndex] ??
                                                                          false
