...
class CategoryItemScreenState extends State<CategoryItemScreen>
  ...
  bool isgrocery = Get.find<SplashController>().module!.moduleType.toString() ==
                    ...
                    Expanded(
                      ...
                      child: isgrocery
                          ? SingleChildScrollView(
                              controller: scrollController,
                              child: ItemsView(
                                isStore: false, items: item, stores: null,
                                noDataText: 'no_category_item_found'.tr,
